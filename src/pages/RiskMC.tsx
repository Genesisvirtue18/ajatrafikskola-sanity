...
import motorcycleTraining from '@/assets/motorcycle-training.jpg';
import risk1Img from '@/assets/riskmc.jpg';
...
const builder = createImageUrlBuilder(sanityClient);
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Riskettan MC | AJA Trafikskola</title>
        <meta
          name="description"
          content="Riskettan MC utbildning i Stockholm. Obligatorisk riskkurs för motorcykelkörkort."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="Riskettan MC | AJA Trafikskola" />
        <meta
